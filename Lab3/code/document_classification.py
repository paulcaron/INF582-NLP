...
path_to_data = r"C:\Users\paulc\Desktop\INF582\lab3\for_moodle\data" # add your absolute path here
...
c_g = terms_to_graph(terms_by_doc, window_size = w, overspanning=False) ### fill the gap ### hint: use the terms_to_graph function with the proper arguments
